...
import { AddButtonModule } from './add-button.component';

@Component({
  selector: 'app-ui-feedback-list-header',
  template: `
    <div
      class="h-20 p-6 flex items-center justify-between rounded-lg bg-indigo-900"
    >
      <div class="flex items-center">
        ...
        <div class="text-neutral-50 text-lg font-bold tracking-tight">
          <span class="mr-2">{{ listCount }}</span>
          <span>Suggestions</span>
        </div>
      </div>
      <app-add-button link="create">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
...
export class UIFeedbackListHeaderComponent {
  @Input()
  listCount = 0;
}
...
@NgModule({
  ...
  declarations: [UIFeedbackListHeaderComponent],
  exports: [UIFeedbackListHeaderComponent],
})
export class UIFeedbackListHeaderModule {}
